...
Tempo is not used as a command to synchronise everything. It establishes a climate: a tendency for rotation, recurrence and breath. The work remains slightly disobedient to the beat because complete obedience would turn listening into measurement.
...
The interface is therefore neither neutral nor ornamental. It choreographs distance. From afar, Range Echo is an image in continuous formation. At close range, it becomes permeable to touch and choice.
...
Range Echo is composed less from objects than from arrivals and disappearances.
